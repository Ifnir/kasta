...
FILE="$HOME/.config/polybar/tran/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/tran/scripts/rofi/launcher.rasi
